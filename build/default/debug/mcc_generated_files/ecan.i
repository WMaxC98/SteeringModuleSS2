...
# 32 "mcc_generated_files/../driveControl/commControl.h"
...
# 85 "mcc_generated_files/ecan.c"
    convertCANid2Reg(0x7FF, 1, &RXM0EIDH, &RXM0EIDL, &RXM0SIDH, &RXM0SIDL);

    convertCANid2Reg(0x7FF, 1, &RXF0EIDH, &RXF0EIDL, &RXF0SIDH, &RXF0SIDL);
    convertCANid2Reg(0x7FF, 1, &RXF1EIDH, &RXF1EIDL, &RXF1SIDH, &RXF1SIDL);


    convertCANid2Reg(0x03F, 1, &RXM1EIDH, &RXM1EIDL, &RXM1SIDH, &RXM1SIDL);

    convertCANid2Reg(0x4, 1, &RXF2EIDH, &RXF2EIDL, &RXF2SIDH, &RXF2SIDL);
    convertCANid2Reg(0x03F, 1, &RXF3EIDH, &RXF3EIDL, &RXF3SIDH, &RXF3SIDL);
    convertCANid2Reg(0x4, 1, &RXF4EIDH, &RXF4EIDL, &RXF4SIDH, &RXF4SIDL);
    convertCANid2Reg(0x4, 1, &RXF5EIDH, &RXF5EIDL, &RXF5SIDH, &RXF5SIDL);
