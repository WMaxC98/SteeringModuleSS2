    ...
    if (oldSMState != me->setupSM_State) {
        ...
        switch (me->setupSM_State) {
            ...
            case ST_SSMINIT0:
                ...
                POST(me, &setupSM_processEvent, evSICheck0, 50, 0);
            break;
            case ST_SSMICHECK0:
            ...
            case ST_SSMINITRS:
                ...
                POST(me, &setupSM_processEvent, evSICheckRS, 50, 0);
            break;
            case ST_SSMICHECKRS:
            ...
            case ST_SSMINIT6:
                ...
                POST(me, &setupSM_processEvent, evSICheck6, 50, 0);
            break;
            case ST_SSMICHECK6:
            ...
            case ST_SSMINIT7:
                ...
                POST(me, &setupSM_processEvent, evSICheck7, 50, 0);
            break;
            case ST_SSMICHECK7:
            ...
            case ST_SSMINIT15:
                ...
                POST(me, &setupSM_processEvent, evSICheck15, 50, 0);
            break;
            case ST_SSMICHECK15:
...
# 337 "driveControl/setupSM.c"
                }
                POST(me, &setupSM_processEvent, evSHCheck6, 50, 0);
            break;
            case ST_SSMHCHECK6:
                if(sepos_receive_modOfOpp(sepos()) == 0x0006){
            ...
            case ST_SSMHOM31:
                ...
                POST(me, &setupSM_processEvent, evSHCheck31, 50, 0);
            break;
            case ST_SSMHCHECK31:
            ...
            break;
            case ST_SSMHCHECK1000:
                if((sepos_receive_statusword(sepos())&0x0100) == 0x0100){
                    POST(me, &setupSM_processEvent, evSHom15, 0, 0);
                }
                else{
                    POST(me, &setupSM_processEvent, evSHom1000, 0, 0);
                }
            ...
            case ST_SSMHOM15:
                ...
                POST(me, &setupSM_processEvent, evSHCheck15, 50, 0);
            break;
            case ST_SSMHCHECK15:
                if(sepos_receive_controlword(sepos()) == 0x000F){
            ...
            case ST_SSMHOM1:
                ...
                POST(me, &setupSM_processEvent, evSHCheck1, 50, 0);
            break;
            case ST_SSMHCHECK1:
                if(sepos_receive_modOfOpp(sepos()) == -1){
                    uCAN_MSG msgs;
                    msgs.frame.idType = 1;
                    msgs.frame.id = 0x510;
                    msgs.frame.dlc = 2;
