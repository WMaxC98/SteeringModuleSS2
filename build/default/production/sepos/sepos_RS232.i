...
# 16 "sepos/sepos_RS232.h"
# 1 "sepos/../mcc_generated_files/mcc.h" 1
# 49 "sepos/../mcc_generated_files/mcc.h"
...
# 49 "sepos/../mcc_generated_files/mcc.h" 2
...
void sepos_send_RS232(uint8_t length){
    txdata[length] = 0;
    txdata[length] = sepos_CalcFieldCRC(txdata,length + 1);

    txbuf[0 + 2*length] = txdata[length];
...
void sepos_receive_RS232(){
    ...
    for(uint8_t i = 2; i < rxbuf[1] * 2 + 6; i++){
      rxbuf[i] = UART1_Read();
    }

    UART1_Write(0x4F);
# 114 "sepos/sepos_RS232.c"
}
